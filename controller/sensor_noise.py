...
from controller.quad_utils import quat2R, quatXquat
...
class SensorNoise:
    def __init__(self,
                 pos_norm_std = 0.005, pos_unif_range = 0.,
                 vel_norm_std = 0.01, vel_unif_range = 0.,
                 quat_norm_std = 0., quat_unif_range = 0.,
                 omega_norm_std = 0., omega_unif_range = 0.,
                 ...
                 acc_static_noise_std = 0.002, acc_dynamic_noise_ratio = 0.005):
                        ...
                        # quat_norm_std=0., quat_unif_range=0.,
                        # omega_norm_std=0., omega_unif_range=0.,
                        # gyro_noise_density=0., gyro_random_walk=0.,
                        # gyro_bias_correlation_time=0., bypass=False,
                        # acc_static_noise_std=0., acc_dynamic_noise_ratio=0.):
        ...
        self.omega_norm_std = omega_norm_std
        self.omega_unif_range = omega_unif_range
    ...
    def add_noise(self, pos, vel, rot, omega, acc, dt):
        ...
        ## Noise in omega
        noisy_omega = omega +\
                    normal(loc=0., scale=self.omega_norm_std, size=3) + \
                    uniform(low=-self.vel_unif_range, high=self.vel_unif_range, size=3)       
        # noisy_omega = self.add_noise_to_omega(omega, dt)
        # print(f"noise_omega is {noisy_omega}")
